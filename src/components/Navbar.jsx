...
const Navbar = () => {
  ...
  return (
    <div className=" max-sm:hidden flex items-center bg-black/40 rounded-r-none h-20 p-2 justify-between text-slate-50">
      <span className="font-black text-xl flex items-center md:hidden lg:block max-md:hidden">ChitChat</span>
      <div className="flex items-center gap-2">
        <img
          ...
          alt="profile image"
        />
        <span className="line-clamp-1 break-all">{user?.displayName}</span>
        <Button
